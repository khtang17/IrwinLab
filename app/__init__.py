...
admin.add_view(UserView(User, db.session, "Current Members", endpoint='/Users'))
admin.add_view(FormerUserView(User, db.session, "Former Members", endpoint='/Former_User'))
